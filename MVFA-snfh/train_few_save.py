...
def save_image(tensor, filename):
    ...
    # Simplified filename for testing
    test_filename = os.path.join('test_images', filename)
    
    if not os.path.exists('test_images'):
        os.makedirs('test_images')
    
    print(f"Saving image to {test_filename}")  # Debug print
        ...
        with torch.no_grad(), torch.cuda.amp.autocast():
            ...
            if CLASS_INDEX[args.obj] > 0:
                ...
                for idx, p in enumerate(seg_patch_tokens):
                    ...
                    anomaly_map_few_shot = F.interpolate(anomaly_map_few_shot, size=args.img_size, mode='bilinear', align_corners=True)
                ...
                save_image(torch.tensor(score_map_zero), os.path.join(output_dir, f'seg_zero_{idx}.png'))
                save_image(torch.tensor(score_map_few), os.path.join(output_dir, f'seg_few_{idx}.png'))
